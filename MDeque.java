...
public class MDeque<E> implements Iterable<E>{
    ...
    public E popBack(){
        ...
        // if length is divisible by 2 remove back, return its value, and set middle to the previous node
        else if(length % 2 == 0){
            E temp = back.getVal();
        ...
        //if none of the above remove back and return its value
        else{
            E temp = back.getVal();
            back.getPrev().setNext(null);
            back = back.getPrev();
    ...
    public E popFront(){
        ...
        //if length is divisible by 2 remove the front node and return its value
        else if(length % 2 == 0){
            E temp = front.getVal();
        ...
        //if none of the above remove the front node, return its value, and set middle to the next node
        else{
            E temp = front.getVal();
            front.getNext().setPrev(null);
            front = front.getNext();
    ...
    public E popMiddle(){
        ...
        //if length is 2 remove the middle node, return its value, and set back equal to front
        else if(length == 2){
            E temp = middle.getVal();
            middle = front;
            middle.setNext(null);
        ...
        //if length is even but not 2 or 0 remove middle and return its value and set middle to the previous node
        ...
        // if none of the above, remove middle, return its value and set middle to the next node
        else{
            E temp = middle.getVal();
            Node before = middle.getPrev();
            Node after = middle.getNext();
    ...
    public void pushBack(E item) {
        ...
        //if length is odd then add the new node to the back and set middle to the next node
        else if(length % 2 == 1){
        ...
        //if none of the above then add the new node to the back
        else{
            Node newBack = new Node(item, null, back);
            back.setNext(newBack);
            back = newBack;
    ...
    public void pushFront(E item) {
        ...
        //if length is odd then add the new node to the front
        else if(length % 2 == 1){
        ...
        //if none of the above then add the new node to the front and move middle to the next node
        else{
            Node newFront = new Node(item, front, null);
            front.setPrev(newFront);
            front = newFront;
    ...
    public void pushMiddle(E item){
        ...
        // if length is 1 then add the new middle to the middle index and set middle and back to it
        else if(length == 1){
            Node after = middle.getNext();
        ...
        // if length is odd but not 1 then add a new node to the middle and set middle to it
        else if(length % 2 == 1 && length > 1){
            Node after = middle.getNext();
            Node newMid = new Node(item, after, middle);
            middle.setNext(newMid);
            after.setPrev(newMid);
            middle = newMid;
            length++;
        }
        // if none of the above then add a new node to the middle and set middle to it
        else{
            Node before = middle.getPrev();
            Node newMid = new Node(item, middle, before);
            middle.setPrev(newMid);
            before.setNext(newMid);
            middle = newMid;
            length++;
        }
    }
